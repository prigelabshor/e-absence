...
export default function RekapPage() {
    ...
    ? {
        pageTitle: "Rekap Absensi Formal",
        pageDesc: "Lihat rekapitulasi dan statistik kehadiran siswa di kelas formal.",
        filterTitle: "Filter Data",
        filterDesc: "Pilih kelas dan rentang waktu untuk melihat rekap.",
        classSelectPlaceholder: "Pilih Kelas",
        tableTitle: "Tabel Rekap Kehadiran Formal",
        tableDesc: "Rincian jumlah kehadiran per siswa.",
        studentNameCol: "Nama Siswa",
        pdfTitle: "Rekap Absensi Formal",
        studentIdCol: "ID Siswa",
      }
    : {
        pageTitle: "Rekap Absensi Halaqah",
        pageDesc: "Lihat rekapitulasi dan statistik kehadiran santri di halaqah.",
        filterTitle: "Filter Data",
        filterDesc: "Pilih halaqah dan rentang waktu untuk melihat rekap.",
        classSelectPlaceholder: "Pilih Halaqah",
        tableTitle: "Tabel Rekap Kehadiran Halaqah",
        tableDesc: "Rincian jumlah kehadiran per santri.",
        studentNameCol: "Nama Santri",
        pdfTitle: "Rekap Absensi Halaqah",
    ...
    const studentStats = useMemo((): StudentStats[] => {
        ...
        return studentsInClass.map(student => {
            ...
            const totalValidForPercentage = total - sakit - izin;
            return {
                student,
                hadir,
                sakit,
                ...
                alfa,
                total,
                percentage: totalValidForPercentage > 0 ? ((hadir / totalValidForPercentage) * 100) : 0,
            };
        });
    ...
    const renderContent = () => {
        ...
        if(!selectedClass || classes.length === 0){
             return <p className="text-center col-span-full py-12">Silakan tambahkan data {I18N.classSelectPlaceholder.toLowerCase()} terlebih dahulu di halaman Kelola {I18N.classSelectPlaceholder}.</p>
        }
        return (
                    ...
                    {isLoadingOverall ? <Loader2 className="h-6 w-6 animate-spin"/> : (
                         <>
                             ...
                             <p className="text-xs text-muted-foreground">
                                 Persentase kehadiran dari semua kelas ({timeFilter})
                             </p>
                         </>
                    )}
                </CardContent>
